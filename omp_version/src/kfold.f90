...
! ==============================================================================
      ...
      PROGRAM KFOLD
        ...
        !$omp private (i, j, tout, time, io, dt ) &
        !$omp shared(tstart, ibpi, tmax, istop, ibpf, nn, nsim) &
        !$omp firstprivate(iseed, istart, rna)
        !!$acc firstprivate(rna, rna%ibsp, rna%seq, rna%iseq, rna%link, &
        !!$acc rna%loop, rna%nhlx, rna%nsgl, rna%n, rna%nl, rna%nsum, &
        !!$acc rna%psum, rna%ptot, rna%wrk1, rna%wrk2)
